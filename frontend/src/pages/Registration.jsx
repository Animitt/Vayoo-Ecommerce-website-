  ...
  return (
    ...
    flex flex-col items-center justify-start'>
      ...
      <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
        <span className='text-[30px] font-semibold'>Create Account</span>
        <span className='text-[15px] '>Welcome to Vayoo, please register to place your order!</span>
      </div>
      ...
      border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
        <form action="" className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
          <div className='w-[95%] h-[50px] bg-[#42656cae] rounded-lg flex items-center justify-center
            ...
            <img src={googlelogo} alt='google logo' className='w-[22px]' />Register using Google Account
          </div>
          ...
          <div className='w-[90%] h-[400px] flex flex-col items-center  justify-cemter gap-[15px] relative '>
            <input type='text' className='w-[100%] h-[50px] border-[2px] border-[#96969675] backdrop:blur-sm rounded-lg
                shadown-lg bg-transparent placeholder-[#ffffffc7] px-[20px] font-semibold' placeholder='Username' required />
            <input type='text' className='w-[100%] h-[50px] border-[2px] border-[#96969675] backdrop:blur-sm rounded-lg
            ...
            {!showPassword && < IoEyeOutline className='w-[17px] h-[17px] cursor-pointer absolute right-[3%] bottom-[51%]' onClick={()=>setShowPassword(prev=>!prev)} />}
            { showPassword && <IoEye className='w-[17px] h-[17px] cursor-pointer absolute right-[3%] bottom-[51%]' onClick={()=>setShowPassword(prev=>!prev)}/>}
            <button type='text' className='w-[100%] h-[50px] bg-[#6060f5] rounded-lg flex-items-center justify-center
                mt-[20px] text-[17px] font-semibold' required >Create Account</button>
